...
class DiagnosticoExport implements FromQuery, WithHeadings, WithMapping, ShouldAutoSize
{
    ...
    public function headings(): array
    {
        return [
            ...
            '35. ¿De qué forma se hace la disposición de residuos orgánicos (provenientes de la preparación de alimentos) del PAE en esta sede educativa?',
            '36. ¿De qué forma se hace la disposición de residuos no orgánicos (envases de plástico, metal, vidrio, cartón, etc.) del PAE en esta sede educativa?',
            ...
            '75. ¿De cuántos pocillos o vasos en buen estado cuentan para el consumo de alimentos?',
