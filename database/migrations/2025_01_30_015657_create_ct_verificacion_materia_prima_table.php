...
return new class extends Migration {
    public function up() {
        Schema::create('ct_verificacion_materia_prima', function (Blueprint $table) {
            $table->id();
            $table->string('etc',60);
            ...
            $table->integer('numero_visita')->nullable();
    ...
    public function down() {
        Schema::dropIfExists('ct_verificacion_materia_prima');
    }
};
